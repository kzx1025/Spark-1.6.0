...
public final class SparkJavaLR {

  public static final int D = 10;   // Number of dimensions
  private static final Random rand = new Random(42);
  public static double[] w = new double[D];
  ...
  public static void main(String[] args) {
    ...
    if (args.length < 3) {
      System.err.println("Usage: SparkJavaLR <file> <iters> <Appname>");
      System.exit(1);
    }

    SparkConf sparkConf = new SparkConf().setAppName(args[2]).setMaster("local");
    //JavaSparkContext sc = new JavaSparkContext(FlintContext.create(sparkConf));
